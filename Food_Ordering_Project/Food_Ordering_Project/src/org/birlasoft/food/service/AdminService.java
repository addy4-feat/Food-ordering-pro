...
public interface AdminService {
	//public void valid_adlogin(String username,String password ) throws SQLException, ClassNotFoundException;
	//public void addFood(String fName,int fPrice,String fAval) throws SQLException;
//	public void RemoveFood(int Fid) throws SQLException;
//	public void foodPriceUpdate(int fid,int fprice) throws SQLException;
//	public void foodNameUpdate(int fid,String fname) throws SQLException;
...
//	
	...
	public int deleteCustomer(int custid) throws SQLException, Exception;
